...
_s[0] = [
	{a:'bg_colour', d:{colour: 'rgba(235, 235, 235, 1)'}}
];

_s[1] = [
	{a:'lyrics', d:{txt:'Wanna see some baby sloths?', x: 200, y: 200, colour:'rgba(0, 0, 0, 1)'}}
];

_s[21] = [
	{a:'datafeed_slideshow', d:{url: 'sloths.rss', duration: 9}}
];
