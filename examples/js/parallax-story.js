...
_s[1] = [
	{a:'lyrics', d:{txt:'Parallax to the left, moving automatically', x: 80, y: 100, colour:'rgba(50, 50, 50, 1)'}}
];

_s[16] = [
	{a:'flicker_parallax', d: {
         layers: ['pix/demo_back.png', 'pix/demo_middle.png', 'pix/demo_front.png'],
         duration: 16, auto:true, direction:'left'}}
];

_s[40] = [
	{a:'lyrics', d:{txt:'Parallax to the right, moving automatically', x: 80, y: 100, colour:'rgba(50, 50, 50, 1)'}}
];

_s[56] = [
	{a:'flicker_parallax', d: {
         layers: ['pix/demo_back.png', 'pix/demo_middle.png', 'pix/demo_front.png'],
         duration: 16, auto:true, direction:'right'}}
];

_s[78] = [
	{a:'lyrics', d:{txt:'This time, use your mouse for the effect', x: 80, y: 100, colour:'rgba(50, 50, 50, 1)'}}
];
