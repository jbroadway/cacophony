...
_s[1] = [
	{a:'lyrics', d:{txt:'Draw me a picture with your mouse', x: 120, y: 200, colour:'rgba(50, 50, 50, 1)'}}
];
...
_s[101] = [
	{a:'lyrics', d:{txt:'Now let\'s see your picture again', x: 140, y: 200, colour:'rgba(50, 50, 50, 1)'}}
];

_s[110] = [
	{a:'flicker_panels', d: {images: ['ribbon', 'ribbon', 'ribbon', 'ribbon'], duration: 24}},
];

_s[112] = [
	{a:'bg_fade_to', d:{colour: "rgba(200, 220, 240, %d)"}}
];

_s[115] = [
	{a:'bg_fade_to', d:{colour: "rgba(220, 240, 200, %d)"}}
];

_s[118] = [
	{a:'bg_fade_to', d:{colour: "rgba(240, 220, 200, %d)"}}
];

_s[121] = [
	{a:'bg_fade_to', d:{colour: "rgba(200, 200, 200, %d)"}}
];

_s[141] = [
	{a:'lyrics', d:{txt:'Neat, eh? :)', x: 330, y: 200, colour:'rgba(50, 50, 50, 1)'}}
];
