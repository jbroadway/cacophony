...
_s[0] = [
	{a:'bg_colour', d:{colour: 'rgba(30, 30, 45, 1)'}}
];

_s[1] = [
	{a:'lyrics', d:{txt:'Wanna play with my shiny new 3D cube?', x: 100, y: 200, colour:'rgba(225, 225, 225, 1)'}}
];

_s[18] = [
	{a:'three_on', d:{func:three_cube, colour:[.2, .3, .45, 1]}}
];
...
_s[141] = [
	{a:'lyrics', d:{txt:'Neat, eh? :)', x: 350, y: 200, colour:'rgba(225, 225, 225, 1)'}}
];
