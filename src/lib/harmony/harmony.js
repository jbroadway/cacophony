...
var SCREEN_WIDTH = cacophony.width,
    SCREEN_HEIGHT = cacophony.height,
    BRUSH_SIZE = 1,
    BRUSH_PRESSURE = 1,
    COLOR = [0, 0, 0],
...

{
	...
	container = $('#cacophony-canvas3').get (0);
...

{
	...
	mouseX = event.clientX - $('#cacophony-canvas3').get (0).offsetLeft; //event.clientX;

	mouseY = event.clientY - $('#cacophony-canvas3').get (0).offsetTop; //event.clientY;
...

{
	...
	brush.strokeStart (
		event.clientX - $('#cacophony-canvas3').get (0).offsetLeft,
		event.clientY - $('#cacophony-canvas3').get (0).offsetTop
	);
